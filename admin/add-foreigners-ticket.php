...
if (strlen($_SESSION['zmsaid']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        // Insert into the tblticforeigner table
        $query = mysqli_query($con, "INSERT INTO tblticforeigner (visitorName,TicketID,NoAdult,NoChildren,AdultUnitprice,ChildUnitprice) VALUES ('$vname','$ticketid','$noadult','$nochildren','$aprice','$cprice')");
        if ($query) {
            ...
            if ($stmt) {
                ...
                echo "Failed to prepare statement for revenue calculation: " . mysqli_error($con);
            }
...
<head>
    ...
    <title>Add Foreigner Ticket - Anantara</title>
