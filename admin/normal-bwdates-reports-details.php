...
<head>
    ...
    <title>View Ticket Generating Report - Anantara</title>
...
function CallPrint(strid) {
    var prtContent = document.querySelector(".data-tables"); // Select the div with class "data-tables"
    var WinPrint = window.open('', '', 'left=0,top=0,width=800,height=900,toolbar=0,scrollbars=0,status=0');
    WinPrint.document.write('<html><head><title>Print</title>');
    WinPrint.document.write('</head><body>');
    WinPrint.document.write(prtContent.innerHTML); // Print the content of the div
